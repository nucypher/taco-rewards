...
contract RewardsDistributor is Ownable {
     ...
     * @param merkleCumulativeAmount Cumulative amount of rewards of the stake
    ...
    function claim(
        ...
        require(alreadyClaimed < merkleCumulativeAmount, "Nothing to claim");
        cumulativeClaimed[stakingProvider] = merkleCumulativeAmount;

        // Send the tokens
        unchecked {
            uint256 amount = merkleCumulativeAmount - alreadyClaimed;
